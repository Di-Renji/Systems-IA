                        ...
                        <div class="card-body">
                            ...
                            <div class="col-12 col-sm-12 col-xl-12 my-auto">
                                <div class="d-flex d-sm-block d-md-flex align-items-center">
                                    ...
                                    <h2 class="mb-0" style="text-align:center; color:black;">Expresión 02/10 : "El encapsulamiento permite ocultar los detalles internos de un objeto"</h2>
                                </div> <br><br><br>
                                
                                <div class="col-sm-12" style="text-align:center">
                                    <a href="desafio1_preg3.php">
                                ...
                                <div class="progress" style="border-radius:20px:">
                                    <div class="progress-bar progress-bar-striped bg-info" role="progressbar" style="width: 20%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">20 %</div>
                                </div>
                            </div>                      
                            </div>
                        </div>
